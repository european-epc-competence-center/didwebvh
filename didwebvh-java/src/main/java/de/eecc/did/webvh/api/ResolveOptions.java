 ...
 * omitted, the built-in {@link de.eecc.did.webvh.crypto.DefaultVerifier} is used.
 *
 * <p>Example:
 * <pre>{@code
...
public final class ResolveOptions {
    ...
    public Verifier getVerifier() {
        return verifier != null ? verifier : de.eecc.did.webvh.crypto.DefaultVerifier.instance();
    }
